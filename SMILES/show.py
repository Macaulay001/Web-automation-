...
# tk.Label(window, text="Choose Bank").grid(row=18, column=0)
# banks = ["FCMB", "Polaris Bank", "Access Bank"]
# selected_bank = tk.StringVar()
# selected_bank.set('Choose Bank')
# dropdown = ttk.Combobox(window, textvariable=selected_bank, values=banks)
# dropdown.grid(row=19, column=0)
# if selected_bank.get() == "FCMB":
#     bonk = "FCMBS"
# if selected_bank.get() == "Polaris Bank":
#     bonk = "Polaris"
# if selected_bank.get() == "Access Bank":
#     bonk = "AccessS"
...
tk.Label(window, text="Access Bank").grid(row=18, column=1)
input_field57 = tk.Entry(window)
input_field57.grid(row=19, column=1)

tk.Label(window, text="Polaris Bank").grid(row=18, column=2)
...
def save_data():
    ...
    sheet3.cell(row=max_row3+1, column=8, value=input_field57.get())
    sheet3.cell(row=max_row3+1, column=9, value=input_field58.get())
    sheet3.cell(row=max_row3+1, column=10, value=input_field59.get())
    sheet3.cell(row=max_row3+1, column=3, value=input_field59.get())
    sheet3.cell(row=max_row3+1, column=4, value=input_field60.get())
    sheet3.cell(row=max_row3+1, column=6, value=input_field61.get())
